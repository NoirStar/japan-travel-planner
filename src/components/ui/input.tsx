  ...
  return (
    <input
      ...
      className={cn(
        ...
        "focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-2 dark:focus-visible:border-cyan dark:focus-visible:ring-cyan/30 dark:focus-visible:shadow-[0_0_10px_rgba(6,182,212,0.1)]",
