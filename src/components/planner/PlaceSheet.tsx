            ...
            <div className="flex flex-col gap-2">
                ...
                return (
                  <div
                    ...
                    className={`flex items-center gap-2 rounded-lg border p-2 transition-all ${
                      isAdded ? "border-primary/30 bg-primary/5" : "border-border hover:border-primary/30 hover:shadow-sm"
                    }`}
              ...
              {isShowingCache && hasMoreCached && (
                <button
                  ...
                  className="mt-1 w-full rounded-xl border border-dashed border-border py-2.5 text-xs text-muted-foreground transition-colors hover:border-primary hover:text-foreground"
                >
