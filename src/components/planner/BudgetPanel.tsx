            ...
            {editingBudget ? (
              <div className="flex items-center gap-1.5">
                ...
                <button
                  ...
                  className="rounded bg-indigo px-2 py-0.5 text-[10px] font-bold text-primary-foreground"
                >
                  저장
                </button>
              </div>
              ...
              <button
                ...
                className="font-bold text-foreground hover:text-indigo transition-colors"
              >
