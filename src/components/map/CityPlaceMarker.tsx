...
/** Teardrop pin SVG path — 36×48 viewBox, tip at bottom-center */
const PIN_PATH = "M18 46C15.5 39 4 28 4 17A14 14 0 1 1 32 17C32 28 20.5 39 18 46Z"

const isTouchDevice = typeof window !== "undefined" && ("ontouchstart" in window || navigator.maxTouchPoints > 0)

// ── Presentational pin subcomponent ────────────────────────
...
const PinVisual = memo(function PinVisual({
  color, icon, isPremium, isSelected, opacity, category,
  ...
  return (
    ...
    >
      ...
      >
        {isSelected && (
          <path d={PIN_PATH} stroke={color} strokeWidth="4" opacity="0.22" fill="none" />
        )}
 ...
 * AdvancedMarker + DOM 기반 teardrop pin + Lucide 아이콘.
 * 호버 → 미니 툴팁 (이름+별점)
  ...
  return (
    <>
      ...
      >
        <PinVisual
          color={color}
          icon={<CategoryIcon size={15} color={color} strokeWidth={2.2} />}
          isPremium={isPremium}
