...
export function AIChatWizard() {
  ...
  return (
    <div className="flex h-screen flex-col bg-sakura-pattern pt-16" data-testid="wizard-page">
      {/* 헤더 */}
      <div className="flex items-center gap-3 border-b border-border/70 bg-card/90 px-5 py-3 backdrop-blur-sm">
        <Button
          variant="ghost"
          size="icon"
          onClick={() => navigate("/")}
