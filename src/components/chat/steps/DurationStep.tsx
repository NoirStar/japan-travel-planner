    ...
    >
      {options.map((opt) => (
        <button
          ...
          className="rounded-full border border-border/50 bg-card px-5 py-2.5 text-sm font-medium shadow-sm transition-colors hover:bg-primary hover:text-primary-foreground hover:border-transparent"
